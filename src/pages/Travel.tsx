...
import { Calendar, User, Heart, MessageCircle, Share2, Clock, Search, Filter, MapPin } from "lucide-react";
...
const Travel = () => {
  ...
  const travelArticles = [
    {
      ...
      excerpt: "Discover breathtaking destinations off the beaten path that offer authentic cultural experiences.",
      author: "Maria Santos",
    ...
    },
    {
      ...
      excerpt: "How to explore the world responsibly while minimizing your environmental footprint.",
      author: "Tom Johnson",
    ...
    },
    {
      ...
      excerpt: "Best cities for remote workers seeking adventure, affordable living, and reliable internet.",
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Searching travel articles for:", searchQuery);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
      ...
      {/* Hero Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-slate-800 to-orange-600 text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto">
            Explore the world through inspiring travel stories, destination guides, and adventure tips from seasoned travelers.
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto flex gap-4">
            ...
            <Button type="submit" className="h-14 px-8 bg-orange-600 hover:bg-orange-700 text-white">
              Search
            </Button>
          </form>
        </div>
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-12">
          <h2 className="text-4xl font-bold text-slate-800">Latest Travel Articles</h2>
              ...
              <CardContent className="pt-0">
                <div className="flex items-center justify-between text-sm text-slate-500 mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-gradient-to-r from-orange-600 to-slate-800 rounded-full flex items-center justify-center text-white text-xs font-bold">
